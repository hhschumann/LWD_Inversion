...
<img src="https://render.githubusercontent.com/render/math?math= \frac{\delta\phi_d}{\delta} = {\phi_d} %2B {\beta} {\phi_m} =\parallel W_d (F[h] - d_{obs}) \parallel^2_2 %2B \parallel W_m h \parallel^2_2">    [2]
